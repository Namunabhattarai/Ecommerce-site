        ...
        <div class="container">
          <div class="az-content-body">
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                Category Name: <input type="text" name="name" id="" class="form-control" value="{{ old('name') }}"
                @error('name')
                ...
                Description: <textarea name="description" id="" cols="30" rows="10" class="form-control">{{ old('description') }}</textarea> <br><br>
